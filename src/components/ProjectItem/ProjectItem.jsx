      ...
      <div class="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
        ...
        <div class="flex">
          <Link
            to={projectUrl}
            target="_blank"
            class="px-8 py-2 mt-4 mr-8 shadow-xl shadow-gray-400 rounded-xl uppercase bg-gradient-to-r from-black-500 text- to-slate-500 text-gray-100 hover:scale-125 ease-in duration-100"
          >
            Demo
          </Link>
